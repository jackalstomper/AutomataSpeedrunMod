...
BOOL __stdcall DXGIFactoryWrapper::IsCurrent() {
    return m_target->IsCurrent();
}

BOOL __stdcall DXGIFactoryWrapper::IsWindowedStereoEnabled() {
    return m_target->IsWindowedStereoEnabled();
}

HRESULT __stdcall DXGIFactoryWrapper::CreateSwapChainForCoreWindow(IUnknown* pDevice, IUnknown* pWindow, const DXGI_SWAP_CHAIN_DESC1* pDesc, IDXGIOutput* pRestrictToOutput, IDXGISwapChain1** ppSwapChain) {
...
HRESULT __stdcall DXGIFactoryWrapper::CreateSwapChainForComposition(IUnknown* pDevice, const DXGI_SWAP_CHAIN_DESC1* pDesc, IDXGIOutput* pRestrictToOutput, IDXGISwapChain1** ppSwapChain) {
